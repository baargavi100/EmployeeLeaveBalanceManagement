...
public class AdminDashboardResponse {
    ...
    public void setNewEmployeeesPendingOnboarding(int count) {
        this.newEmployeesPendingOnboarding = count;
    }

    public Integer getNewEmployeeesPendingOnboarding() {
        return newEmployeesPendingOnboarding;
    }
}
